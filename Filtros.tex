...
\begin{demo}[i] Por un lado, se va a mostrar que si $\U$ es un ultrafiltro,
  ...
  \begin{longderivation}
    ...
    \equiv\\
      { \Exists{A}{A \in \U_2 - \U} }\\
    \why{ $\U$ cumple (i) y $A \not\in \U$ }\\
      { \Exists{A}[A\in\U_2-\U]{I-A\in\U} }\\
    \why[\To]{$\U\subset\U_2$}\\
      { \Exists{A}[A\in\U_2-\U]{I-A\in \U_2} }\\
    \equiv\\
...
\begin{demo}
  ...
  entonces que
  \begin{longderivation}
      { \Forall{n}[n\in\J]{F_n\in\U} \land \bigcap_{n\in\J} F_n \not\in \U}\\
    \why{ $\U$ es un ultrafiltro }\\
      { \Forall{n}[n\in\J]{I - F_n \not\in \U} \land
  ...
  \begin{longderivation}
    ...
    =\\
      { B_{n+1} - B_{n} }\\
    =\\
      { \bigcup_{k=1}^{n+1}(I-F_k) - \bigcup_{k=1}^{n}(I-F_k)}\\
    =\\
      { \left((I-F_{n+1}) \cup \bigcup_{k=1}^{n}(I-F_k)\right)
    ...
    =\\
      { \left((I-F_{n+1}) \cap
            ...
            \right) }\\
    =\\
      { (I-F_{n+1}) \cap \bigcap_{k=1}^{n}F_k }
  \end{longderivation}
...
\begin{demo}
  ...
  \begin{longderivation}
      { \bigcap_{n\in P}(I - I_n) \cap \bigcap_{n\in P_2} (I - H_n) }\\
    =\\
      { I - \left(\bigcup_{n\in P_1} I_n \cup \bigcup_{n\in P_2} H_n\right) }
  \end{longderivation}
