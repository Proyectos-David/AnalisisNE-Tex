...
\begin{demo}
  ...
  \begin{longderivation}<.9>
      { \Forall{c}[c\in\IRh]{a\inu c \equiv b \inu c} }\\
    \To\\
    ...
    \item Sean $n\in\J$, $\{a_k\}$ una colección con $n$ elementos de
          ...
          \begin{itemize}
            ...
            \noindent\makebox[14.5cm]{
                  \begin{tabular}{>{$}c<{$} | >{$}c<{$}}
                    \begin{derivation}
                        { x \in \bigcap_{k=1}^n \st{a_k} }\\
                      \equiv\\
                        { \Forall{k}[1\leq k\leq n]{x \in \st{a_k}} }\\
                      \equiv\\
                        {
                    ...
                    &
                    \begin{derivation}
                        { x \in\st{\left(\,\bigcap_{k=1}^n a_k\right)} }\\
                      \equiv\\
                        {
            ...
            \item Para la unión.
                  ...
                  \begin{longderivation}
                    ...
                    \equiv\\
                      { \Exists{k}[1\leq k\leq 1]{x\in\st{a_k}} }\\
                    \equiv\\
  ...
  \begin{enumerate}
    ...
    \item Sean $n\in\N$, $b\in\R_{n+1}$ y $a\in b$.
          ...
          \begin{longderivation}
              {a\in b}\\
            \To\\
              {\Forall{i}[i\in B]{a(i)\in\R_0\cup\R_n}}\\
            \equiv\\
              { \set{i}{a(i)\in\R_0\cup\R_n}\in\U }\\
...
\begin{demo}
  ...
  \begin{longderivation}
    ...
    \equiv\\
      {(y_1,\dots,y_m)\in\set{(x_1,\dots,x_m)\in\st{a}}{\st{V(x_1,\dots,x_m)}}}
  \end{longderivation}
...
\begin{demo}
  ...
  \begin{longderivation}<.8>
    ...
    \equiv\\
      {\set{i}{(a_1,\dots,a_{n-1}) \in a_n}\in\U}
  \end{longderivation}
